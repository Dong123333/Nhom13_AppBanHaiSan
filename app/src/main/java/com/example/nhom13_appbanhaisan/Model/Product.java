...
public class Product {
    ...
    public Product(String anh, String ten_san_pham, String gia, int so_luong_da_ban, String quy_cach, String mo_ta, String mon_ngon, String tinh_trang, String xuat_xu, int so_luong_ton_kho) {
        this.anh = anh;
